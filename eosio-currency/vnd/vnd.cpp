...
void vnd::create(const asset &max_supply)
{
...
void vnd::issue(const name &to, const asset &quantity, const string &memo)
{
    require_auth(get_self());
...
void vnd::transfer(const name &from, const name &to, const asset &quantity, const string &memo)
{
    require_auth(from);
